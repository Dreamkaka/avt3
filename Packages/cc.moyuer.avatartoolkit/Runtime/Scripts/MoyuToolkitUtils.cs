...
namespace VRChatAvatarToolkit
{
    public class MoyuToolkitUtils
    {
        ...
        public static string GetScriptPath()    // TODO 替换掉
        {
            var path = AssetDatabase.GetAssetPath(MonoScript.FromScriptableObject(ScriptableObject.CreateInstance<MoyuToolkit>()));
